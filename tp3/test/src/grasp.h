...
vector<conjunto>  grasp(vector<vector<int> >& mz_ady, vector<conjunto>& partes, list<int>& candidatos, vector<int>& vistos, int k, int semilla, int modo_uso_grasp, int modo_uso_goloso, int it_grasp, int cant_elegir){
...
int peso_grasp(list<arista>& aristas, int n, int k, int semilla, int modo_uso_grasp, int modo_uso_goloso, int it_grasp, int cant_elegir){
	...
	vector<conjunto> res = grasp(mz_ady, partes, candidatos, vistos, k, semilla, modo_uso_grasp, modo_uso_goloso, it_grasp, cant_elegir);
