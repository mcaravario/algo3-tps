...
./run_grasp_n.sh 200 500 20 13 1 1 5 20 > grasp.11.5.20.out
./run_grasp_n.sh 200 500 20 13 1 1 25 20 > grasp.11.25.20.out
./run_grasp_n.sh 200 500 20 13 1 1 5 40 > grasp.11.5.40.out
./run_grasp_n.sh 200 500 20 13 1 1 25 40 > grasp.11.25.40.out
