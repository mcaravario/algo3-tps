...
./run_exacto_aleatorio.sh 3 5 20 13 > exacto.rand.k3.out
./run_exacto_aleatorio.sh 4 5 20 13 > exacto.rand.k4.out
...
./run_exacto_malo.sh 3 5 20 13 > exacto.malo.k3.out
./run_exacto_malo.sh 4 5 20 13 > exacto.malo.k4.out
